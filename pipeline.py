...
def _fetch_org_summary(org: dict, timespan: int = 604800) -> dict:
    ...
    # Active Alerts Queue is populated 100% with Ground Truth Meraki Assurance Alerts
    # (Matches Meraki Dashboard 100%: 7 Alerts for BIS SECURITIES, 1 Alert for Marico SEA)
